(ns javierrweiss.sci-extensions
    (:require [javierrweiss.custom]
              [sci.ctx-store]
              [sci.core :as sci]))
...
(def custom-namespace
  (sci/copy-ns javierrweiss.custom
               (sci/create-ns 'javierrweiss.custom)))
...
(def custom-namespaces
  {'javierrweiss.custom custom-namespace
...
;; `:as` form to a namespace: `(:require [javierrweiss.custom :as custom])`
(def custom-aliases
  {'custom 'javierrweiss.custom})
